...
$$.Object = {"": [],
 ...
 drawPatches$1: function($0) {
  return this.noSuchMethod$2("drawPatches", [$0]);
 },
 ...
 addDataPoint$2: function($0, $1) {
  return this.noSuchMethod$2("addDataPoint", [$0, $1]);
 },
 ...
 animate$0: function() {
  return this.noSuchMethod$2("animate", []);
 },
 ...
 resizeToFitScreen$2: function($0, $1) {
  return this.noSuchMethod$2("resizeToFitScreen", [$0, $1]);
 },
 ...
 patchAt$2: function($0, $1) {
  return this.noSuchMethod$2("patchAt", [$0, $1]);
 },
 ...
 addTurtle$1: function($0) {
  return this.noSuchMethod$2("addTurtle", [$0]);
 },
 drawImage$5: function($0, $1, $2, $3, $4) {
  return this.noSuchMethod$2("drawImage", [$0, $1, $2, $3, $4]);
 },
 ...
 drawTurtles$1: function($0) {
  return this.noSuchMethod$2("drawTurtles", [$0]);
 },
 ...
 get$turtles: function() {
  return this.noSuchMethod$2("get:turtles", []);
 },
 get$top: function() {
 ...
 get$model: function() {
  return this.noSuchMethod$2("get:model", []);
 },
 ...
 get$nextTurtleId: function() {
  return this.noSuchMethod$2("get:nextTurtleId", []);
 },
 get$ignoreCase: function() {
 ...
 set$isExtendable: function($0) {
  return this.noSuchMethod$2("set:isExtendable", [$0]);
 },
 ...
 set$dirty: function($0) {
  return this.noSuchMethod$2("set:dirty", [$0]);
 },
...
$$.NetTango = {"": ["pctx", "tctx", "gctx", "model?", "toolbar", "plot", "width=", "height=", "ticks", "play_state", "pframe", "mdown"],
 "super": "TouchManager",
 tick$0: function() {
 ...
 get$tick: function() { return new $.BoundClosure(this, 'tick$0'); },
 ...
 animate$0: function() {
  ...
  var t1 = this.ticks;
  if ($.mod(t1, 10) === 0)
    this.plot.addDataPoint$2(t1, $.get$length(this.model.get$turtles()));
},
 draw$0: function() {
  this.model.drawPatches$1(this.pctx);
  this.tctx.clearRect$4(0, 0, this.width, this.height);
  this.model.drawTurtles$1(this.tctx);
  this.plot.draw$1(this.gctx);
},
 NetTango$0: function() {
  this.width = $.window().get$innerWidth();
  this.height = $.window().get$innerHeight();
  var canvas = $.document().query$1('#patches');
  this.pctx = canvas.getContext$1('2d');
  canvas.set$width(this.width);
  canvas.set$height(this.height);
  canvas = $.document().query$1('#turtles');
  this.tctx = canvas.getContext$1('2d');
  this.registerEvents$1(canvas);
  canvas.set$width(this.width);
  canvas.set$height(this.height);
  canvas = $.document().query$1('#plot');
  this.gctx = canvas.getContext$1('2d');
  this.plot = $.StackGraph$(canvas.get$width(), canvas.get$height());
  this.model = $.Model$(this);
  this.model.resizeToFitScreen$2(this.width, this.height);
  this.play$1(1);
  this.toolbar = $.Toolbar$(this.model);
}
};
...
$$.TouchManager = {"": [],
 ...
 findTouchTarget$1: function(tp) {
  for (var t1 = $.iterator($.TouchManager_touchables); t1.get$hasNext() === true;) {
    var t2 = t1.next$0();
 ...
 get$mouseUp: function() { return new $.BoundClosure0(this, 'mouseUp$1'); },
 ...
 get$mouseDown: function() { return new $.BoundClosure0(this, 'mouseDown$1'); },
 ...
 get$mouseMove: function() { return new $.BoundClosure0(this, 'mouseMove$1'); },
 touchDown$1: function(tframe) {
  for (var t1 = $.iterator(tframe.get$changedTouches()); t1.get$hasNext() === true;) {
    var t2 = t1.next$0();
    if (t2.get$down() === true) {
 ...
 processTouches$1: function(data) {
  ...
  var changed = [];
  for (var t1 = $.iterator(frame.get$touches()), down = false, drag = false, up = false; t1.get$hasNext() === true;) {
    var t2 = t1.next$0();
    if (t2.get$down() === true) {
...
$$.TouchEvent = {"": ["id?", "touchX?", "touchY?", "up?", "down?", "drag?", "finger"],
 "super": "Object",
 ...
 TouchEvent$fromMouse$1: function(mouse) {
  this.id = -1;
  this.touchX = mouse.get$offsetX();
  this.touchY = mouse.get$offsetY();
  this.finger = true;
}
};

$$.Turtle = {"": ["rnd", "id?", "x?", "y?", "size?", "heading?", "color?", "tween", "model?", "dead?", "energy="],
 "super": "Object",
 ...
 wrapX$1: function(tx) {
  if ($.ltB(tx, this.model.get$minWorldX()))
    return $.add(tx, this.model.get$worldWidth());
  else if ($.gtB(tx, this.model.get$maxWorldX()))
    return $.sub(tx, this.model.get$worldWidth());
  else
    return tx;
},
 wrapY$1: function(ty) {
  if ($.ltB(ty, this.model.get$minWorldY()))
    return $.add(ty, this.model.get$worldHeight());
  else if ($.gtB(ty, this.model.get$maxWorldY()))
    return $.sub(ty, this.model.get$worldHeight());
  else
    return ty;
},
 ...
 get$left: function() { return new $.BoundClosure0(this, 'left$1'); },
 right$1: function(degrees) {
  this.left$1($.neg(degrees));
},
 die$0: function() {
  this.dead = true;
  this.color.setColor$4(0, 0, 0, 255);
},
 hatch$0: function() {
  $.Turtle$clone(this).energy = 50;
  this.energy = 50;
},
 draw$1: function(ctx) {
  ctx.save$0();
  ctx.translate$2(this.x, this.y);
  ctx.rotate$1(this.heading);
 ...
 animate$0: function() {
  ...
  this.forward$1(0.1);
  var t1 = this.rnd;
  this.right$1(t1.nextInt$1(20));
  this.left$1(t1.nextInt$1(20));
  var p = this.patchHere$0();
  var t2 = p.get$energy();
  if (typeof t2 !== 'number')
    return this.animate$0$bailout(1, p, t1, t2);
  if (t2 > 10) {
    var t3 = this.energy;
    if (typeof t3 !== 'number')
      return this.animate$0$bailout(2, p, t1, t3);
    t3 = t3 < 100;
  } else
    t3 = false;
  if (t3) {
    ...
    t3 = this.energy;
    if (typeof t3 !== 'number')
      return this.animate$0$bailout(4, t3, t1, 0);
    this.energy = t3 + 2;
  }
  t2 = this.energy;
  if (typeof t2 !== 'number')
    return this.animate$0$bailout(5, t2, t1, 0);
  this.energy = t2 - 1;
  t2 = this.energy;
  if (typeof t2 !== 'number')
    return this.animate$0$bailout(6, t1, t2, 0);
  if (t2 <= 0)
    this.die$0();
  else if (t2 > 90) {
    t1 = t1.nextInt$1(100);
    if (typeof t1 !== 'number')
      return this.animate$0$bailout(8, t1, 0, 0);
    if (t1 > 98)
      this.hatch$0();
  }
  t1 = this.energy;
 ...
 animate$0$bailout: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      p = env0;
      t1 = env1;
  ...
  switch (state0) {
    ...
    case 1:
      state0 = 0;
    case 2:
      if (state0 === 2 || state0 === 0 && $.gtB(t2, 10))
        switch (state0) {
          case 0:
            t2 = this.energy;
          case 2:
    ...
    default:
      if (state0 === 4 || state0 === 3 || state0 === 0 && t2)
        switch (state0) {
          ...
          case 3:
            state0 = 0;
            p.set$energy($.sub(t2, 10));
            p.set$dirty(true);
            var t4 = this.energy;
          case 4:
            state0 = 0;
            this.energy = $.add(t4, 2);
        }
      t2 = this.energy;
    case 5:
      state0 = 0;
      this.energy = $.sub(t2, 1);
      t2 = this.energy;
    case 6:
      state0 = 0;
    case 7:
    case 8:
      if (state0 === 0 && $.leB(t2, 0))
        this.die$0();
      else
        switch (state0) {
          case 0:
          ...
          case 7:
            state0 = 0;
          case 8:
            if (state0 === 8 || state0 === 0 && $.gtB(t2, 90))
              switch (state0) {
                case 0:
                  t1 = t1.nextInt$1(100);
                case 8:
 ...
 containsTouch$1: function(event$) {
  var tx = this.model.screenToWorldX$2(event$.get$touchX(), event$.get$touchY());
  if (typeof tx !== 'number')
    return this.containsTouch$1$bailout(1, event$, tx, 0, 0);
  var ty = this.model.screenToWorldY$2(event$.get$touchX(), event$.get$touchY());
  if (typeof ty !== 'number')
  ...
  var t3 = this.size;
  if (typeof t3 !== 'number')
    return this.containsTouch$1$bailout(4, t1, ty, t3, tx);
  if (tx >= t1 - t3 / 2)
    if (tx <= t1 + t3 / 2) {
      t1 = this.y;
      if (typeof t1 !== 'number')
        return this.containsTouch$1$bailout(7, ty, t1, 0, 0);
      if (ty >= t1 - t3 / 2) {
        var t2 = ty <= t1 + t3 / 2;
        t1 = t2;
      } else
 ...
 containsTouch$1$bailout: function(state0, env0, env1, env2, env3) {
  ...
  switch (state0) {
    ...
    case 4:
      state0 = 0;
    default:
      if (state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 0 && $.geB(tx, $.sub(t1, $.div(t3, 2))))
        switch (state0) {
          case 0:
            t1 = this.x;
          case 5:
          ...
          case 6:
            state0 = 0;
          default:
            if (state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 0 && $.leB(tx, $.add(t1, $.div(t3, 2))))
              switch (state0) {
                case 0:
                  t1 = this.y;
                case 7:
                ...
                case 8:
                  state0 = 0;
                default:
                  if (state0 === 10 || state0 === 9 || state0 === 0 && $.geB(ty, $.sub(t1, $.div(t3, 2))))
                    switch (state0) {
                      case 0:
                        t1 = this.y;
                      case 9:
 ...
 Turtle$clone$1: function(parent$) {
  this.model = parent$.get$model();
  this.id = this.model.get$nextTurtleId();
  this.x = parent$.get$x();
  this.y = parent$.get$y();
  this.size = parent$.get$size();
  this.heading = parent$.get$heading();
  this.color = parent$.get$color().clone$0();
  this.dead = false;
  this.model.addTurtle$1(this);
},
 Turtle$2: function(id, model) {
  this.heading = this.rnd.nextInt$1(360);
...
$$.Patch = {"": ["x?", "y?", "color?", "model?", "dirty!", "energy="],
 ...
 animate$0$bailout: function(state0, env0) {
  switch (state0) {
    case 1:
      t1 = env0;
      break;
  ...
  switch (state0) {
    ...
    case 1:
      state0 = 0;
    case 2:
      if (state0 === 2 || state0 === 0 && $.ltB(t1, 100))
        switch (state0) {
          case 0:
            t1 = this.energy;
          case 2:
            state0 = 0;
            this.energy = $.add(t1, 1);
            this.dirty = true;
        }
  }
},
 draw$1: function(ctx) {
  if (this.dirty === true) {
    ...
    var t3 = $.toInt(t1 / 100 * 255);
    if (typeof t3 !== 'number')
      throw $.iae(t3);
    t3 = 255 - t3;
    this.color.set$alpha(t3);
    ctx.set$fillStyle(this.color.toString$0());
    ctx.fillRect$4(this.x - 0.5, this.y - 0.5, 1, 1);
    this.dirty = false;
  }
},
 draw$1$bailout: function(state0, env0, env1) {
  switch (state0) {
    case 1:
      var ctx = env0;
      t1 = env1;
  ...
  switch (state0) {
    case 0:
    case 1:
      if (state0 === 1 || state0 === 0 && this.dirty === true)
        switch (state0) {
          case 0:
            ctx.clearRect$4(this.x - 0.5, this.y - 0.5, 1, 1);
            var t1 = this.energy;
          case 1:
            state0 = 0;
            var t3 = $.toInt($.mul($.div(t1, 100), 255));
            if (typeof t3 !== 'number')
              throw $.iae(t3);
            t3 = 255 - t3;
            this.color.set$alpha(t3);
 ...
 containsTouch$1$bailout: function(state0, env0, env1) {
  switch (state0) {
    case 1:
      var event$ = env0;
      tx = env1;
...
$$.Model = {"": ["turtles?", "patches", "ntango", "patchSize", "maxPatchX", "minPatchX", "maxPatchY", "minPatchY", "TURTLE_ID"],
 "super": "Object",
 addTurtle$1: function(t) {
  $.add$1(this.turtles, t);
  $.add$1($.TouchManager_touchables, t);
},
 resizeToFitScreen$2: function(screenW, screenH) {
  var t1 = this.patchSize;
  var hpatches = $.tdiv(screenW, t1);
  if (typeof hpatches !== 'number')
    return this.resizeToFitScreen$2$bailout(1, screenH, hpatches, t1);
  var vpatches = $.tdiv(screenH, t1);
  if (typeof vpatches !== 'number')
    return this.resizeToFitScreen$2$bailout(2, vpatches, hpatches, 0);
  ...
  this.patches = $.ListImplementation_List(hpatches);
  for (var i = 0; i < hpatches; ++i) {
    $.indexSet(this.patches, i, $.ListImplementation_List(vpatches));
    for (var j = 0; j < vpatches; ++j) {
 ...
 resizeToFitScreen$2$bailout: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      var screenH = env0;
      hpatches = env1;
  ...
  switch (state0) {
    ...
    case 2:
      ...
      this.minPatchY = $.add($.sub(this.maxPatchY, vpatches), 1);
      this.patches = $.ListImplementation_List(hpatches);
      for (var i = 0; $.ltB(i, hpatches); ++i) {
        $.indexSet(this.patches, i, $.ListImplementation_List(vpatches));
        for (var j = 0; $.ltB(j, vpatches); ++j) {
          t1 = $.index(this.patches, i);
          var t2 = this.minPatchX;
          if (typeof t2 !== 'number')
            throw $.iae(t2);
 ...
 tick$1: function(count) {
  var i = $.sub($.get$length(this.turtles), 1);
  if (typeof i !== 'number')
    return this.tick$1$bailout(1, i);
  for (; i >= 0; --i) {
    var t = $.index(this.turtles, i);
    if (t.get$dead() === true) {
      $.removeAt$1(this.turtles, i);
  ...
  if (!(t1 == null))
    for (t1 = $.iterator(t1); t1.get$hasNext() === true;)
      for (var t2 = $.iterator(t1.next$0()); t2.get$hasNext() === true;)
        t2.next$0().animate$0();
},
 tick$1$bailout: function(state0, i) {
 ...
 Model$1: function(ntango) {
  ...
  for (var i = 0; i < 60; ++i) {
    var t = $.Turtle$(this.get$nextTurtleId(), this);
    var t1 = $.mod(i, 5);
...
$$.Toolbar = {"": ["buttons", "ctx", "target", "model?", "pstate", "width=", "height=", "x?", "y?", "playButton", "pauseButton"],
 "super": "Object",
 action$1: function(act) {
  this.draw$0();
},
 get$action: function() { return new $.BoundClosure0(this, 'action$1'); },
 draw$0: function() {
  var w = this.width;
  var h = this.height;
  this.ctx.clearRect$4(0, 0, w, h);
  for (var t1 = $.iterator(this.buttons); t1.get$hasNext() === true;)
    t1.next$0().draw$1(this.ctx);
},
 get$draw: function() { return new $.BoundClosure(this, 'draw$0'); },
 animate$0: function() {
},
 Toolbar$1: function(model) {
  var canvas = $.document().query$1('#toolbar');
  this.ctx = canvas.getContext$1('2d');
  this.width = canvas.get$width();
  this.height = canvas.get$height();
  this.buttons = $.ListImplementation_List(null);
  var w = this.width;
  var button = $.Button$($.add($.sub($.tdiv(w, 2), 20), 3), 8, 40, 30, 'play');
  button.setImage$1('images/play.png');
  $.TouchManager_addTouchable(button);
  $.add$1(this.buttons, button);
  button.onClick = this.get$action();
  button.onDown = this.get$action();
  var t1 = this.pstate === 0;
  button.enabled = t1;
  button.visible = t1;
  ...
  $.TouchManager_addTouchable(button);
  $.add$1(this.buttons, button);
  button = $.Button$(10, 8, 40, 30, 'restart');
...
$$.Button = {"": ["action", "img", "x?", "y?", "w", "h", "onClick", "onDown", "enabled", "down?", "visible", "checked"],
 "super": "Object",
 ...
 containsTouch$1: function(event$) {
  ...
  if (typeof tx !== 'number')
    return this.containsTouch$1$bailout(1, event$, tx, 0);
  var ty = event$.get$touchY();
  if (typeof ty !== 'number')
    return this.containsTouch$1$bailout(2, tx, ty, 0);
  var t1 = this.x;
  if (typeof t1 !== 'number')
...
$$.StackGraph = {"": ["width=", "height=", "refresh", "MARGIN", "data?", "maxX", "maxY"],
 "super": "Object",
 addDataPoint$2: function(tick, value) {
  this.data.push($.DataPoint$(tick, value));
  var t1 = this.maxX;
  this.maxX = t1 > tick ? t1 : tick;
  this.maxY = $.gtB(this.maxY, value) ? this.maxY : value;
},
 draw$1: function(ctx) {
  if (this.refresh) {
    ctx.set$fillStyle('#333');
    ctx.fillRect$4(0, 0, this.width, this.height);
    var x = this.MARGIN;
    var t1 = this.width;
    if (typeof t1 !== 'number')
      return this.draw$1$bailout(1, ctx, x, t1, 0, 0);
    var t3 = x * 2;
    var w = t1 - t3;
    t1 = this.height;
    if (typeof t1 !== 'number')
      return this.draw$1$bailout(2, ctx, x, t3, w, t1);
    var h = t1 - t3;
    ...
    ctx.beginPath$0();
    ctx.moveTo$2(x, t3);
    for (var i = 0; t1 = this.data, t2 = t1.length, i < t2; ++i) {
      var value = t1[i];
      t1 = x + i;
      var t2 = value.get$value();
      if (typeof t2 !== 'number')
        throw $.iae(t2);
      ctx.lineTo$2(t1, t3 - t2);
    }
    ctx.lineTo$2(x + t2, t3);
    ctx.closePath$0();
    ctx.set$fillStyle('rgba(0, 100, 200, 0.8)');
    ctx.fill$0();
    this.refresh = true;
  }
},
 draw$1$bailout: function(state0, env0, env1, env2, env3, env4) {
  switch (state0) {
    case 1:
      var ctx = env0;
      x = env1;
  ...
  switch (state0) {
    case 0:
    default:
      if (state0 === 2 || state0 === 1 || state0 === 0 && this.refresh)
        switch (state0) {
          case 0:
            ctx.set$fillStyle('#333');
            ctx.fillRect$4(0, 0, this.width, this.height);
 ...
 StackGraph$2: function(width, height) {
  this.data = $.ListImplementation_List(null);
}
};

$$.DataPoint = {"": ["tick", "value="],
 "super": "Object",
 tick$1: function(arg0) { return this.tick.call$1(arg0); }
};
...
$$.JsonObject = {"": ["_jsonString=", "_objectData=", "isExtendable!"],
 ...
 _extractElements$1: function(data) {
  if (typeof data === 'object' && data !== null && data.is$Map())
    data.forEach$1(new $.JsonObject__extractElements_anon(data, this));
 ...
 isEmpty$0: function() {
  return this._objectData.isEmpty$0();
},
 ...
 operator$indexSet$2: function(key, value) {
  if ($.eqB(this.isExtendable, true) || this.containsKey$1(key) === true) {
    ...
    throw $.$$throw($.throwRuntimeError('cannot resolve UnsupportedOperationException'));
},
 remove$1: function(key) {
  if ($.eqB(this.isExtendable, true) || this.containsKey$1(key) === true)
...
$$.JsonObject__extractElements_anon = {"": ["data_1", "this_0"],
 "super": "Closure",
 call$2: function(key, value) {
  if (typeof value === 'object' && value !== null && value.is$Map())
    $.indexSet(this.data_1, key, $.JsonObject$fromMap(value));
...
$.NetTango$ = function() {
  var t1 = new $.NetTango(null, null, null, null, null, null, 1000, 700, 0, 0, null, false);
  t1.TouchManager$0();
  t1.NetTango$0();
  return t1;
};
...
$.Model$ = function(ntango) {
  var t1 = new $.Model(null, null, ntango, 40, 12, -12, 12, -12, 0);
  t1.Model$1(ntango);
  return t1;
};
...
$.Toolbar$ = function(model) {
  var t1 = new $.Toolbar(null, null, null, model, 0, 440, 70, null, null, null, null);
  t1.Toolbar$1(model);
  return t1;
};

$.StackGraph$ = function(width, height) {
  var t1 = new $.StackGraph(width, height, true, 8, null, 0, 0);
  t1.StackGraph$2(width, height);
  return t1;
};

$.TouchEvent$fromMouse = function(mouse) {
  var t1 = new $.TouchEvent(null, 0, 0, false, false, false, false);
...
$.Turtle$ = function(id, model) {
  var t1 = new $.Turtle($.Random_Random(null), id, 3, 1.5, 1, 0, null, null, model, false, 100);
  t1.Turtle$2(id, model);
  return t1;
};

$.Turtle$clone = function(parent$) {
  var t1 = new $.Turtle($.Random_Random(null), null, 3, 1.5, 1, 0, null, null, null, false, 100);
  t1.Turtle$clone$1(parent$);
  return t1;
};

$.Patch$ = function(model, x, y) {
  var t1 = new $.Patch(x, y, null, model, true, 100);
  t1.Patch$3(model, x, y);
  return t1;
};

$.Button$ = function(x, y, w, h, action) {
  return new $.Button(action, null, x, y, w, h, null, null, true, false, true, false);
};
...
$.DataPoint$ = function(tick, value) {
  return new $.DataPoint(tick, value);
};
...
$.$defineNativeClass('HTMLInputElement', {"": ["height=", "pattern?", "size?", "src!", "value=", "width="],
 get$on: function() {
...
$.$defineNativeClass('Touch', {"": ["identifier?", "pageX?", "pageY?"],
 get$_target: function() {
  return this.target;
}
});
